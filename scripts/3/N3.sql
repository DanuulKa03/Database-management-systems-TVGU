...
select estimation, count(estimation) from student_discipline group by estimation order by estimation
...
select d.title_discipline, sd.estimation, count(sd.estimation) from student_discipline as sd
join discipline as d on sd.n_discipline = d.n_discipline
group by d.title_discipline, sd.estimation order by d.title_discipline, sd.estimation
...
select title_discipline from discipline 
where n_discipline in (
