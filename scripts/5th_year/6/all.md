...
***1.2 Пользователь может получить доступ на запись (update) к записям своего уровня секретности и ниже.***  
***1.3 Пользователь может получить доступ на создание (insert) к записям своего уровня секретности и выше.***  
***1.4 Пользователь может получить доступ на удаление (delete) к записям своего уровня секретности и ниже.***  
...
| Мандат | Описание строки                        | Уровень секретности |
| ----------------- | ------------------------------------ | ------------------- |
| Студент 0 уровня  | Данные студентов 1–2 курса | 0                   |
| Студент 1 уровня  | Данные студентов 3–4 курса | 1                   |
| Студент 2 уровня  | Данные студентов 5–6 курса | 2                   |
